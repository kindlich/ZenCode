...
import org.openzen.zenscript.javabytecode.compiler.expression_visitor.handlers.CallHandler;
...
public class JavaExpressionVisitor implements ExpressionVisitor<Void>, JavaNativeTranslator<Void> {
	...
	public Void visitCall(CallExpression expression) {
		new CallHandler(this).visitCall(expression);
		return null;
	}

	public void handleTypeArguments(FunctionalMemberRef member, CallArguments arguments) {
	...
	public void handleCallArguments(Expression[] arguments, FunctionParameter[] parameters, boolean variadic) {
		if (variadic) {
